...
# Input paths
parser.add_argument('--model', type=str, default='E:\\hoc_voi_cha_hanh\\advanced_cv\\project\\ver3\\ImageCaptioning.pytorch\\log_ktvic_updown\\model-best.pth',
                help='path to model to evaluate')
parser.add_argument('--cnn_model', type=str,  default='resnet101',
                help='resnet101, resnet152')
parser.add_argument('--infos_path', type=str, default='E:\\hoc_voi_cha_hanh\\advanced_cv\\project\\ver3\\ImageCaptioning.pytorch\\log_ktvic_updown\\infos_ktvic_test-best.pkl',
