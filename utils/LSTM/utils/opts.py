...
def parse_opt():
    ...
    parser.add_argument('--force_cpu', type=int, default=0,
                    help='Set to 1 to force training/inference on CPU even if CUDA is available (useful for CPU-only builds).')
    parser.add_argument('--num_workers', type=int, default=4,
                    help='Number of worker processes for PyTorch DataLoader; set 0 on Windows to avoid h5py pickling issues.')
    parser.add_argument('--pin_memory', type=int, default=1,
                    help='Whether to pin dataloader memory (1) or not (0).')
    ...
    parser.add_argument('--train_split', type=str, default='train',
                    help='Name of the split in input_json to use for training set filtering.')
    parser.add_argument('--val_split', type=str, default='val',
                    help='Name of the validation split in input_json.')
    parser.add_argument('--test_split', type=str, default='test',
                    help='Name of the test split in input_json.')
...
def add_eval_options(parser):
    ...
    parser.add_argument('--language_eval', type=int, default=0,
                    help='Evaluate language as well (1 = yes, 0 = no)? BLEU/CIDEr/METEOR/ROUGE_L? requires coco-caption code from Github.')
    parser.add_argument('--language_eval_bleu_only', type=int, default=None,
                    help='If 1, only compute BLEU-4 during language evaluation (None = use checkpoint default).')
    parser.add_argument('--bleu_only', type=int, default=None,
                    help='Alias for BLEU-only evaluation; 1 = only BLEU-4 (None = use checkpoint default).')
    parser.add_argument('--language_eval_json', type=str, default='',
                    help='Optional path to a COCO-style reference json used during evaluation.')
