...
def main(params):
    ...
    imgs = json.load(open(params['input_json'], 'r', encoding='utf-8'))
    imgs = imgs['images']
    ...
    for i,img in enumerate(imgs):
        ...
        if 'cocoid' in img:
            ...
            jimg['id'] = img['imgid']
        elif 'id' in img:             # ★★ thêm đoạn này ★★
            jimg['id'] = img['id']    # copy id từ dataset_ktvic.json
        else:
            raise ValueError(f"Image missing id field: {img}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_h5', default='coco20K_label', help='output h5 file')
