...
# Add project root to sys.path to find _init_paths and other modules
def add_path(path):
    if path not in sys.path:
        sys.path.insert(0, path)

this_dir = osp.dirname(__file__)
# Add .. to path (project root)
...
from utils.feature_extracting.timer import Timer
...
from utils.feature_extracting.config import cfg, cfg_from_file, cfg_from_list, get_output_dir
from models.feature_extracting.rpn.bbox_transform import clip_boxes
# from model.nms.nms_wrapper import nms
from models.feature_extracting.roi_layers import nms
from models.feature_extracting.rpn.bbox_transform import bbox_transform_inv
from utils.feature_extracting.net_utils import save_net, load_net, vis_detections
from utils.feature_extracting.blob import im_list_to_blob
from models.feature_extracting.faster_rcnn.vgg16 import vgg16
from models.feature_extracting.faster_rcnn.resnet import resnet
import pdb
