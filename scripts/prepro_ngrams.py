...
import sys
# Add project root to sys.path (2 levels up from scripts/)
...
def get_doc_freq(refs, params):
    ...
    tmp.document_frequency = defaultdict(float)
...
def main(params):
    ...
    dict_json = json.load(open(params['dict_json'], 'r', encoding='utf-8'))
