...
from utils.RelTR.util import box_ops
from utils.RelTR.util.misc import (NestedTensor, nested_tensor_from_tensor_list,
...
class RelTR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        out = {'pred_logits': outputs_class[-1], 'pred_boxes': outputs_coord[-1],
               ...
               'rel_features': torch.cat((hs_sub, hs_obj, so_masks), dim=-1)}
        if self.aux_loss:
